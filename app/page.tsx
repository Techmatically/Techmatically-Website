    ...
    <main className="bg-background text-foreground">
      ...
      <section
        ...
        onMouseMove={(e) => {
          ...
          e.currentTarget.style.setProperty("--x", `${clientX - rect.left}px`);
          e.currentTarget.style.setProperty("--y", `${clientY - rect.top}px`);
        }}
      >
        <div className="absolute inset-0 bg-grid" />

        <div className="pointer-events-none absolute inset-0 pulse-grid" />
